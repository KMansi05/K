...
{  cleardevice();
   ...
   settextstyle(1,0,5);
   setcolor(RED);
   outtextxy(210,50,"PROJECT MADE BY:");
   setcolor(CYAN);
   settextstyle(2,0,7);
   outtextxy(10,80,"");
   outtextxy(10,110,"PRATIBHA PARASHAR(2102160100076)");
   outtextxy(10,140,"MANSI KUMARI(2102160100055)");
   outtextxy(10,170,"MANSI JAISWAL(2102160100054)");
   outtextxy(10,200,"KOMAL KUMARI(2102160100046)");
   setcolor(RED);
   settextstyle(6,0,4);
   outtextxy(10,230,"CSE 2A");
   outtextxy(10,260,"Computer Science Engineering");
   delay(2500);
}
